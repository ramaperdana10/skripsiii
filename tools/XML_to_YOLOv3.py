...
data_dir = '/prepare_dataset/Dataset/'
Dataset_names_path = "model_data/person_names.txt"
Dataset_train = "model_data/person_train.txt"
Dataset_test = "model_data/person_test.txt"
is_subfolder = True
